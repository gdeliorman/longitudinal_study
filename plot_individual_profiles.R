...
experimental_placebo_case_1_fin1_cgi<- read_csv("/Users/gokcedeliorman/Downloads/experimental_placebo_case_1_fin1_cgi.csv", col_names=TRUE)
...
TZ1<- experimental_case_2_cgi[experimental_case_2_cgi$type2 == "PANSS",]
TZ0<- placebo_case_2_cgi[placebo_case_2_cgi$type2 == "PANSS",]
SZ1<- experimental_case_2_cgi[experimental_case_2_cgi$type2 == "BPRS",]
SZ0<- placebo_case_2_cgi[placebo_case_2_cgi$type2 == "BPRS",]
...
#seperate as surrogate and true endpoint
TZ1<- experimental_placebo_case_1_fin1_cgi[experimental_case_1_fin1_cgi$type2 == "PANSS",]
TZ0<- placebo_case_1_fin1_cgi[placebo_case_1_fin1_cgi$type2 == "PANSS",]
SZ1<- experimental_case_1_fin1_cgi[experimental_case_1_fin1_cgi$type2 == "BPRS",]
SZ0<- placebo_case_1_fin1_cgi[placebo_case_1_fin1_cgi$type2 == "BPRS",]
